...
----------------------------------------------
Objetivo: Estabelecer uma baseline de performance utilizando apenas os dados 
estáticos da transação, sem considerar o histórico do cliente ou do lojista.

Este modelo serve como ponto de partida para medir o ganho incremental de ROI
quando adicionarmos features de estado e latência nos experimentos subsequentes.
"""
