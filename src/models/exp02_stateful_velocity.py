...
---------------------------------------------------------
Objetivo: Incrementar o modelo com features que capturam o comportamento 
histórico do cliente (Stateful), focando em frequência e volume financeiro.

Features implementadas:
1. Contagem de transações nas últimas 24h e 7 dias (Velocity).
2. Razão entre o valor atual e a média de gastos dos últimos 7 dias (Anomalia).
3. Atributos temporais (hora, dia da semana) e demográficos (idade).
"""

import pandas as pd
import numpy as np
from catboost import CatBoostClassifier
from reporter import evaluate_and_report
