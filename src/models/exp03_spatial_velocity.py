...
---------------------------------------------------
Objetivo: Enriquecer o modelo anterior com atributos geoespaciais, 
calculando a distância entre a casa do cliente e o local da transação.

Decisão Arquitetural:
Utilizamos a fórmula de Haversine para cálculo de distância. Embora existam 
fórmulas mais precisas (como Vincenty), o Haversine oferece um balanço 
superior entre precisão aceitável e altíssima velocidade de processamento,
essencial para sistemas de baixa latência.
"""
