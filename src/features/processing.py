...
def haversine_vectorized(lat1: float, lon1: float, lat2: float, lon2: float) -> np.ndarray:
    """
    Calcula a distância do grande círculo entre dois pontos na Terra em quilômetros.
    Utiliza a fórmula de Haversine para eficiência computacional em baixa latência.
